...
#                ('profile_photo', models.ImageField(help_text='Maximum 5 MB file is allowed.', upload_to=apps.mainsite.app_models.users.user_directory_path, verbose_name='Profile Picture')),
